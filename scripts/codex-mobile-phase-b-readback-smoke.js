...
function summarizeDetailResponseBudget(budget = {}) {
  ...
  return {
    ...
    responseBudgetProgressiveActiveFirstPaintThreadByteCeiling: boundedBytes(source.progressiveActiveFirstPaintThreadByteCeiling),
    responseBudgetProgressiveActiveFirstPaintItemBudgetApplied: source.progressiveActiveFirstPaintItemBudgetApplied === true,
