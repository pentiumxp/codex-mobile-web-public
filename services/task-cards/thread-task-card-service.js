...
const TASK_CARD_RETURN_TOOL_HINT = "`mcp__codex_mobile.return_to_source` after Codex Mobile MCP discovery if needed, or `codex_mobile.return_to_source` only when that app-server namespace is actually callable";
