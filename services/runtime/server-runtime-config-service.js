...
function createServerRuntimeConfigService(dependencies = {}) {
  ...
  function resolve() {
    ...
    return {
      ...
      WORKSPACE_DELEGATION_TOOL_NAMESPACE: "mcp__codex_mobile",
      WORKSPACE_DELEGATION_TOOL_NAME: "delegate_to_thread",
      WORKSPACE_DELEGATION_TOOL_FULL_NAME: "mcp__codex_mobile.delegate_to_thread",
      TASK_CARD_RETURN_TOOL_NAME: "return_to_source",
      TASK_CARD_RETURN_TOOL_FULL_NAME: "mcp__codex_mobile.return_to_source",
      ...
      USER_BEHAVIOR_REPAIR_CARDS_DISABLED: boolFlag(env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_CARDS_DISABLED)
        || offFlag(env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_CARDS),
      USER_BEHAVIOR_REPAIR_TARGET_THREAD_ID: env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_TARGET_THREAD_ID || "",
      USER_BEHAVIOR_REPAIR_TARGET_ROLE: env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_TARGET_ROLE || "plugin_worker",
      USER_BEHAVIOR_REPAIR_TARGET_WORKSPACE: env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_TARGET_WORKSPACE || "",
      USER_BEHAVIOR_REPAIR_DEDUPE_WINDOW_MS: boundedNumber(
        env.CODEX_MOBILE_USER_BEHAVIOR_REPAIR_DEDUPE_WINDOW_MS || String(60 * 60 * 1000),
        60 * 60 * 1000,
        60 * 1000,
        24 * 60 * 60 * 1000,
      ),
