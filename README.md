...
- Mobile Web keeps the visible model selector and the submitted model aligned: the selector now contains the effective current/default model as a real option, and message submission sends that effective value instead of an empty placeholder.
