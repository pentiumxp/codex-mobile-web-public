...
## 2026-06-27 Phase A/B Detail Post-Merge And Post-Render Plan Reuse Slice
...
- focused tests 验证 refresh、cached-current、first-paint 和 full-backfill 都走同一套
  post-merge plan，first-paint post-render 走独立 plan，并且
  cached-current/首屏/full-backfill 不再内联旧的 post-merge/post-render 顺序。
