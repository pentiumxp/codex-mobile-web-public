...
test("public app shell cache advances with static frontend changes", () => {
  ...
  assert.match(functionBody("refreshCurrentThread"), /let patchAttemptResultStage = threadDetailRenderPlanApi\.planThreadDetailRefreshPatchAttemptResultStage\(\{/);
  ...
  assert.match(functionBody("refreshCurrentThread"), /if \(patchAttemptResultStage\.needsPatchRejectedVisibleShapes\) \{/);
  assert.match(functionBody("refreshCurrentThread"), /previousVisibleShape: visibleConversationShape\(previousThread\)/);
  assert.match(functionBody("refreshCurrentThread"), /nextVisibleShape: visibleConversationShape\(state\.currentThread\)/);
