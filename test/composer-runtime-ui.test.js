...
test("composer runtime is part of the v616 static shell", () => {
  ...
  assert.match(appJs, /CLIENT_BUILD_ID = "0\.1\.11\|codex-mobile-shell-v616"/);
  assert.match(swJs, /CACHE_NAME = "codex-mobile-shell-v616"/);
});
