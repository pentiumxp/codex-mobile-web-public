...
const serviceBoundaries = [
  ...
  {
    canonical: require("../services/thread-detail/thread-detail-runtime-service"),
    adapter: require("../adapters/thread-detail-runtime-service"),
    exports: ["createThreadDetailRuntimeService"],
  },
  {
