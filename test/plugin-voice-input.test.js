...
test("voice input bridge is limited to Hermes embed mode and uses plugin scripts", () => {
  assert.match(indexHtml, /<script src="\/plugin-voice-input\.js"><\/script>\s*<script src="\/home-ai-diagnostic-reporting\.js"><\/script>\s*<script src="\/thread-diagnostic-events\.js"><\/script>\s*<script src="\/thread-status-hints\.js"><\/script>\s*<script src="\/thread-performance-metrics\.js"><\/script>\s*<script src="\/thread-list-load-policy\.js"><\/script>\s*<script src="\/live-operation-dock-state\.js"><\/script>\s*<script src="\/thread-detail-state\.js"><\/script>\s*<script src="\/thread-detail-render-plan\.js"><\/script>\s*<script src="\/thread-detail-merge-state\.js"><\/script>\s*<script src="\/thread-detail-v4-merge-state\.js"><\/script>\s*<script src="\/thread-detail-patch-plan\.js"><\/script>\s*<script src="\/thread-detail-dom-patch\.js"><\/script>\s*<script src="\/thread-detail-actions\.js"><\/script>\s*<script src="\/thread-tile-actions\.js"><\/script>\s*<script src="\/thread-tile-state\.js"><\/script>\s*<script src="\/thread-tile-layout\.js"><\/script>\s*<script src="\/build-refresh-policy\.js"><\/script>\s*<script src="\/app\.js"><\/script>/);
