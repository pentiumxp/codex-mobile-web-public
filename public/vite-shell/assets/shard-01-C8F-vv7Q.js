...
function sampleModule(id, api) {
	...
	if (id === "app-update-runtime") {
		...
		return {
			ok: runtime && typeof runtime.refreshPageForNewBuild === "function" && client === "客户端 v625 · a5a3d596" && version === "v0.1.11 · 客户端 v625 · a5a3d596" && updateLine === "Update available: abc123" && publicLine === "Public latest: def456" && serverBuild === "client-a",
			client,
			version,
			updateLine,
			publicLine,
