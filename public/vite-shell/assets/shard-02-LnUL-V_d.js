...
function threadListInteractionStallEvent(input = {}) {
	...
	return runtimeEvent({
		...
		severityHint: maxDelayMs >= boundedCount$1(input.h2ThresholdMs || input.h2_threshold_ms || 3e3) ? "H2" : "H3",
...
function normalizeSplitPairs$1(values = [], ids = []) {
...
function threadTileColumnGroups(input = {}) {
	...
	const pairs = normalizeSplitPairs$1(input.splitPairs || input.paneSplitPairs || [], ids);
...
var api$2 = {
	...
	layoutForViewport,
	normalizeSplitPairs: normalizeSplitPairs$1,
...
var moduleApis = {
	"plugin-voice-input": api$9,
	"api-client": api$8,
	"markdown-renderer": api$7,
	"plugin-embed": api$6,
	"frontend-runtime-health": api$5,
	"home-ai-diagnostic-reporting": api$4,
	"thread-diagnostic-events": api$3,
	"thread-tile-layout": api$2,
	"thread-tile-actions": api$1,
	"thread-tile-state": api
};
