...
//#endregion
//#region \0virtual:codex-mobile-shell-build-manifest
var _virtual_codex_mobile_shell_build_manifest_default = {
	"schemaVersion": 4,
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-Ic0roD9P.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-BE1hQ-9I.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-1tgbPwiB.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-Dqb0ENVB.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-wRItYckI.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-DsItsN1T.js"), [])
};
...
function runtimeShellManifest() {
	...
	return _virtual_codex_mobile_shell_build_manifest_default;
}
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-eNKnrZ8e.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-Gyg4imZ4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-DcRUx7r4.js"), []);
...
//#endregion
export { _virtual_codex_mobile_shell_build_manifest_default as n, __commonJSMin as r, __vitePreload as t };
