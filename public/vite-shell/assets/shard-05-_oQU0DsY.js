...
var import_pane_layout_runtime = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function updateConversationHtml(html, signature, options = {}) {
		...
		if (updatePlan.action === "hydrate-existing") {
			...
			if (shouldCheckProjectionConsistency) checkConversationProjectionConsistency(projectionConsistencySource, { renderMode: String(options.renderMode || updatePlan.action || "") });
			return false;
		}
		...
		applyConversationHtmlUpdateEffectsPlan(effectsPlan, { root: conversation });
		restoreConversationViewportAnchor(scrollAnchor);
		if (shouldCheckProjectionConsistency) checkConversationProjectionConsistency(projectionConsistencySource, { renderMode: String(options.renderMode || applicationPlan.finalAction || updatePlan.action || "") });
	...
	(function exposeCodexPaneLayoutRuntime(root) {
		const paneLayoutRuntimeApi = { createPaneLayoutRuntime };
		if (typeof module === "object" && module.exports) module.exports = paneLayoutRuntimeApi;
		Object.assign(root, {
...
if (!root.__CODEX_MOBILE_VITE_APP_PREVIEW_PAGE__ || loadedByClassicAppPreview) startCodexMobileApp();
//#endregion
...
var moduleDefinitions = [{
	...
	"importSource": "public/pane-layout-runtime.js",
