...
(function exposeCodexConversationRenderRuntime(root) {
  root.CodexConversationRenderRuntime = root.CodexConversationRenderRuntime || {
    createConversationRenderRuntime: function createConversationRenderRuntime() {
      return {
      ...
      upsertItem: typeof upsertItem === "function" ? upsertItem : null,
      };
    },
  };
})(window);
