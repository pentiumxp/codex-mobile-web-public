...
const conversationRenderRuntimeApi = Object.freeze({ createConversationRenderRuntime });
const conversationRenderRoot = typeof globalThis !== "undefined" ? globalThis : window;
const legacyGlobals = {
...
Object.assign(conversationRenderRoot, legacyGlobals);
conversationRenderRoot.CodexConversationRenderRuntime = conversationRenderRuntimeApi;

export { createConversationRenderRuntime };
export default conversationRenderRuntimeApi;
