...
export function defaultNormalizeFsPath(value) {
  return String(value || "")
    .replace(/^\\\\\?\\/, "")
    .replace(/[\\/]+/g, "\\")
    .replace(/\\+$/, "")
...
export function normalizeAttachmentMeta(item) {
...
export function attachmentStorageKey(draftKey, attachmentIdValue) {
