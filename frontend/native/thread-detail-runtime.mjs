...
const threadDetailRuntimeApi = Object.freeze({ createThreadDetailRuntime });
const threadDetailRuntimeRoot = typeof globalThis !== "undefined" ? globalThis : window;
threadDetailRuntimeRoot.CodexThreadDetailRuntime = threadDetailRuntimeApi;

export { createThreadDetailRuntime };
export default threadDetailRuntimeApi;
