...
const paneLayoutRuntimeApi = Object.freeze({ createPaneLayoutRuntime });
const paneLayoutRoot = typeof globalThis !== "undefined" ? globalThis : window;
...
export { createPaneLayoutRuntime };
export default paneLayoutRuntimeApi;
