...
const eventStreamRuntimeApi = Object.freeze({ createEventStreamRuntime });
const eventStreamRoot = typeof globalThis !== "undefined" ? globalThis : window;
const legacyGlobals = {
...
Object.assign(eventStreamRoot, legacyGlobals);
eventStreamRoot.CodexEventStreamRuntime = eventStreamRuntimeApi;

export { createEventStreamRuntime };
export default eventStreamRuntimeApi;
