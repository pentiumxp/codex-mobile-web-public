...
| `adapters/thread-goal-service.js` | Read-only `<CODEX_HOME>\goals_1.sqlite` goal lookup, status normalization, public thread goal shape, and list/detail decoration. |
