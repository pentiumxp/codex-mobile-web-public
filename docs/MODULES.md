...
| thread visibility/worktree filtering | `test/thread-visibility.test.js`, `test/thread-archive.test.js`, `test/mobile-viewport.test.js`; include archived-session filtering for state DB and session-index fallback paths |
