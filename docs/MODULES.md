...
| `adapters/chatgpt-pro-mcp-service.js` | Restricted ChatGPT Pro MCP connector JSON-RPC surface, separate runtime-only bearer-token authorization, tool schema projection, and planner-tool dispatch. |
