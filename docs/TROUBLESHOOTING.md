...
| Thread detail shakes during streaming output | Client shell version v316+, `/api/client-events` `conversation_render_ms`, `thread_refresh_ms.skippedDetailRender`, compact Command dock height, stale PWA shell |
