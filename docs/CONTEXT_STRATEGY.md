...
- The Mobile Web conversation should render uploaded image references as centered thumbnails when the saved upload path is available, including when Codex quotes the same `Uploaded attachments:` summary in a later reply.
